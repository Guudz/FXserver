...
ESX.ShowNotification = function(msg, flash, saveToBrief, hudColorIndex, title, subject, icon)
	...
	if title == nil then title = "LystyLife" end
	...
	exports.sNotif:Send(msg, nil, nil, true, nil, title, subject, icon)
end
...
ESX.ShowAdvancedNotification = function(title, subject, msg, banner, timeout, icon)
	...
	exports.sNotif:SendAdvanced(msg, subject, title, banner, timeout, nil, true, nil, icon)
end
