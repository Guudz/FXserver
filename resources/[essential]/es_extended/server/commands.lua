...
ESX.AddGroupCommand('pos', 'fondateur', function(source, args, user)
...
ESX.AddGroupCommand('setjob', 'fondateur', function(source, args, user)
...
ESX.AddGroupCommand('setjob2', 'fondateur', function(source, args, user)
	if tonumber(args[1]) and args[2] and tonumber(args[3]) then
		local xPlayer = ESX.GetPlayerFromId(args[1])
...
ESX.AddGroupCommand('car', 'fondateur', function(source, args, user)
...
ESX.AddGroupCommand('cleargarage', 'fondateur', function(source, args, user)
