...
function RageUI.staffModeDesc(title, color, components)
    if not IsPedInAnyVehicle(PlayerPedId(), false) then
        RageUI.drawTexts(baseX - 0.6500, baseY - (0.100) - 0.013, title, false, 0.50, { 223, 99, 123,  255 }, 4, 0)
        ...
        RageUI.drawTexts(baseX - 0.6500, baseY - 0.110, "", false, 0.7, { 223, 99, 123,  255 }, 4, 0)
    end
end