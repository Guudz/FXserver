...
local ranksInfos = {
    ...
    [2] = { label = "Modérateur", rank = "mod" },
    [3] = { label = "Administrateur", rank = "admin" },
    [4] = { label = "Gérant Légal", rank = "gl" },
    [5] = { label = "Gérant Illégal", rank = "gi" },
    [6] = { label = "Gérant Staff", rank = "gs" },
    [7] = { label = "Main-Team", rank = "mt" },
    [8] = { label = "Développeur", rank = "_dev" },
    [9] = { label = "Co-Fondateur", rank = "cf" },
    [9] = { label = "Fondateur", rank = "fondateur" }
}

local function getRankDisplay(rank)
    local ranks = {
        ["mod"] = "~b~[Modérateur] ~s~",
        ["admin"] = "~y~[Administrateur] ~s~",
        ["gl"] = "~g~[Gérant Légal] ~s~",
        ["gi"] = "~p~[Gérant Illégal] ~s~",
        ["gs"] = "~r~[Gérant Staff] ~s~",
        ["mt"] = "~o~[Main Team] ~s~",
        ["_dev"] = "~r~[Développeur] ~s~",
        ["cf"] = "~u~[Co Fondateur] ~s~",
