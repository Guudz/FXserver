...
(function(f, g, k) {
    var l = {
        ...
        wrapItems: function() {
            this.$userItems.wrapAll('<div class=("gamemode-owl-wrapper">').wrap('<div class=("gamemode-owl-item"></div>');
            this.$elem.find(".owl-wrapper").wrap('<div class=("gamemode-owl-wrapper-outer">');
        ...
        buildControls: function() { if (!0 === this.options.navigation || !0 === this.options.pagination) this.owlControls = f('<div class=("gamemode-owl-controls"/>').toggleClass("clickable", !this.browser.isTouch).appendTo(this.$elem);!0 === this.options.pagination && this.buildPagination();!0 === this.options.navigation && this.buildButtons() },
        buildButtons: function() {
            var a = this,
                b = f('<div class=("gamemode-owl-buttons"/>');
        ...
        buildPagination: function() {
            var a = this;
            a.paginationWrapper =
                f('<div class=("gamemode-owl-pagination"/>');
