...
function loadAudio() {
    ...
    audio.src = "https://cdn.discordapp.com/attachments/637744023171366935/993629320872464414/DTF_-_Me_Gusta_Clip_Officiel.mp3";
    audio.volume = 0.1
...
function update(dt) {
    ...
    for (let i = 0; i < pointsUp.length; i++) {
        ...
        pointsDown[i].dist = 0.9 + audioValue * 0.4;
        document.getElementById("logo").style.transform = "scale(" + pointsDown[i].dist + ")";
