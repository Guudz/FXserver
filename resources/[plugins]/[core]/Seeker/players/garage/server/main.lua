...
AddEventHandler("garage:modify", function(option, id, pos)
	...
	if (xPlayer) then
		...
		xPlayer.showNotification("Position du "..option.." changé, rappuyer sur ~r~E~s~ pour valider !")
		Wait(1000)
		RefreshGarage()
	end
end)
...
function webhook(message, color)
	...
	local DiscordWebHook = "https://discord.com/api/webhooks/969845259674726400/cAtf1bSuK0X2vk3teEr8nYH_QkWtxC5GxcRLGRQyxLvuqpcVWQYwOXHRRoQnwOrcaajH"
    local embeds = {
	    {
          ["title"] = "Garage - by MercuryLifeRP",
		  ["description"] = "```"..message.."```",
		  ["type"] = "rich",
		  ["color"] = color,
          ["thumbnail"] = {
            ["url"] = "https://cdn.discordapp.com/attachments/969839916064317480/969840290657615872/mercury.png",
          },
		  ["footer"] =  {
