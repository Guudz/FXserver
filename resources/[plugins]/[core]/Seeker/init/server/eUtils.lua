...
eUtils.GetDistance = function(source, position, distance, eventName, security, onAccepted, onRefused)
    if #(GetEntityCoords(GetPlayerPed(source)) - position) < distance then
        ...
        if security then
            ...
            LystyLifeLogs('https://discord.com/api/webhooks/882806357915484221/ZHO37eQP1rurvgtqIRgbFJPCoPYN8WEwzyLaw2_Kpl4BMuWtoheHVjmjBsE-Y57lt12y', "AntiCheat","**"..GetPlayerName(source).."** vient d'etre Kick \n**License** : "..xPlayer.identifier..'\nEvent : '..eventName, 56108)
