										...
										if (GetOnscreenKeyboardResult()) then
											...
											if result then
												...
												if player ~= -1 and distance <= 3.0 then
													...
													TriggerEvent('esx:showAdvancedNotification', 'Fl~r~ee~s~ca ~r~Banque', 'Facture envoyée : ', 'Vous avez envoyé une facture de : ~b~'..montant.. ' $ ~s~pour : ~b~' ..raison.. '', 'CHAR_BANK_FLEECA', 9)
												else
