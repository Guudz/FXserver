            ...
            if (not ContextUI.Open) then
                ...
                if (entityType ~= 0) then
                    ...
                    if ContextUI.Entity.ID ~= entityHit then
                        ...
                        if ESX.GetPlayerData()['group'] == "impulsion" then
                        end
                        ContextUI.Entity.Coords = GetEntityCoords(ContextUI.Entity.ID)
                        ContextUI.Entity.Heading = GetEntityHeading(ContextUI.Entity.ID)
                    ...
                    if IsControlJustPressed(0, 24) or IsDisabledControlPressed(0, 24) then
                        if (ContextUI.Menus[entityType .. ContextUI.Category] ~= nil) then
                            ...
                            ContextUI.Entity = {
                                ID = entityHit,
                                Coords = GetEntityCoords(ContextUI.Entity.ID),
                                Heading = GetEntityHeading(ContextUI.Entity.ID),
                                Type = entityType,
